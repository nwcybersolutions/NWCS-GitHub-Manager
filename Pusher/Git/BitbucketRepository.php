...
class BitbucketRepository extends Repository
{
    ...
    {
        $url = 'https://bitbucket.org/' . $this->handle . '/get/' . $this->getBranch() . '.zip?dir=/nwcybersolutions_gm';
    ...
    {
        $response = wp_remote_get("https://cloud.nwcybersolutions.com/auth/bitbucket/refresh-token?refresh_token={$token}");
