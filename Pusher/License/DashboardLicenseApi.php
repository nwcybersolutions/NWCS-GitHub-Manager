...
{
    private $baseUrl = 'https://dashboard.nwcybersolutions.com/api/license-keys/';
    ...
    public function removeLicenseFomSite($key)
    {
        ...
        if ($code !== 200) {
            add_settings_error('invalid-license-server-message', '', 'License could not be revoked from site. Please manually revoke it from the <a href="https://dashboard.nwcybersolutions.com">NWCS GitHub Manager Dashboard</a>.');
        }
    }
}
