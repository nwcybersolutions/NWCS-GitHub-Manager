...
<form action="" method="POST">
    ...
    <input type="hidden" name="nwcybersolutions_gm[action]" value="edit-plugin">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="nwcybersolutions_gm[repository]" value="<?php echo $plugin->repository; ?>">
                <p class="description">Example: nwcybersolutions/awesome-plugin</p>
            </td>
        </tr>
        <tr>
            <th scope="row">
            ...
            <td>
                <input placeholder="master" type="text" name="nwcybersolutions_gm[branch]" value="<?php echo $plugin->repository->getBranch(); ?>">
            </td>
        </tr>
        <tr>
            <th scope="row">
            ...
            <td>
                <input name="nwcybersolutions_gm[subdirectory]" type="text" class="regular-text" placeholder="Optional" value="<?php echo $plugin->getSubdirectory(); ?>">
        ...
        <tr>
            ...
            <td>
                <label><input type="checkbox" name="nwcybersolutions_gm[ptd]" <?php echo ($plugin->pushToDeploy) ? 'checked' : null; ?>> Push-to-Deploy</label>
            </td>
        </tr>
        </tbody>
    </table>
...
<form action="" method="POST">
    ...
    <input type="hidden" name="nwcybersolutions_gm[action]" value="unlink-plugin">
    <input type="hidden" name="nwcybersolutions_gm[file]" value="<?php echo $plugin->file; ?>">
    <input type="submit" class="button button-delete" value="Unlink plugin" style="float:right;">
</form>
<a href="?page=nwcybersolutions_gm-plugins">Back to plugins</a>
<br><br>
