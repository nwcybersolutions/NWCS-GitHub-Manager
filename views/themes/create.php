...
<form action="" method="POST">
    ...
    <input type="hidden" name="nwcybersolutions_gm[action]" value="install-theme">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description">Example: nwcybersolutions/awesome-theme</p>
                </td>
            </tr>
            <tr>
                <th scope="row">
            ...
            <tr>
                <th scope="row"></th>
                <td>
                    <label><input type="checkbox" name="nwcybersolutions_gm[dry-run]" <?php if (isset($_POST['nwcybersolutions_gm']['dry-run'])) echo 'checked'; ?>> <i class="fa fa-link" aria-hidden="true"></i> Link installed theme</label>
                    <p class="description">Let NWCS GitHub Manager take over an already installed theme</p>
